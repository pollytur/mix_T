...
class TestVariationalMixture(unittest.TestCase):
    ...
    def test_variational_fit_students_t(self):
        ...
        print(f"Is the covariance matrix distance < 0.01? {cov_outcome}")
    ...
    def test_log_likelihood_calculation(self):
        ...
        sq_maha_dist = sq_maha_distance(samples, VarMix.loc_, VarMix.scale_cholesky_)
    ...
    def test_sampling_students_t(self):
        ...
        print(f"Are the estimated degrees of freedom between 3.5 and 4.5? {fit_df_outcome}")
